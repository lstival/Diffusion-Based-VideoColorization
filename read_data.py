...
if __name__ == '__main__':
    ...
    dataroot = f"./diffusion/data/latens/{used_dataset}/"
    valid_dataroot = f"./diffusion/data/latens/mini_DAVIS_val/"
    ...
    # pos_dataroot = os.path.join("./diffusion/evals", date_str, used_dataset)
